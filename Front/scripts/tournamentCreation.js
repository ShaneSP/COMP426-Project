...
var tournamentCreationButton = function(wrapper) {
    var tournament_name_form = $("<div class=\"container\">" + "<div class=\"input-group input-group-lg\" style=\"width:700px; background-color: white;\">" +
        "<input type=\"password\" class=\"form-control req_tou_name\" placeholder=\" Tournament Name\" aria-describedby=\"basic-addon1\" style=\"text-align: center; padding-left: 0px; padding-right: 0px; padding-top: 10px; padding-bottom: 10px;\">" +
        "</div>" + "</div>");
    var organizer_form = $("<div class=\"container\">" + "<div class=\"input-group input-group-lg\" style=\"width:700px; background-color: white;\">" +
        "<input type=\"password\" class=\"form-control req_org_name\" placeholder=\" Organizer Name\" aria-describedby=\"basic-addon1\" style=\"text-align: center; padding-left: 0px; padding-right: 0px; padding-top: 10px; padding-bottom: 10px;\">" +
        "</div>" + "</div>");
