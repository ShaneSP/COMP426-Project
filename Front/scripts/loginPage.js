...
var REALLOGINBOIZButton = function(wrapper) {
    var summoner_name_form = $("<div class=\"container\">" + "<div class=\"input-group input-group-lg\" style=\"width:700px; background-color: white;\">" +
        "<input type=\"text\" class=\"form-control req_sum_name\" placeholder=\" Username\" aria-describedby=\"basic-addon1\" style=\"text-align: center; padding-left: 0px; padding-right: 0px; padding-top: 10px; padding-bottom: 10px;\">" +
        "</div>" + "</div>");
    var password_form = $("<div class=\"container\">" + "<div class=\"input-group input-group-lg\" style=\"width:700px; background-color: white;\">" +
        "<input type=\"password\" class=\"form-control req_password\" placeholder=\" Password\" aria-describedby=\"basic-addon1\" style=\"text-align: center; padding-left: 0px; padding-right: 0px; padding-top: 10px; padding-bottom: 10px;\">" +
        "</div>" + "</div>");
