...
var loginButton = function(wrapper) {
    ...
    "<form id= \"summonerName\"> Summoner Name: <br> <input type=\"text\" name= \"Summoner Name\" class = \"req_sum_name\"><br></form>\n"+
    "</div> ");
    var first_name_form = $("<div> \n"  +
    "<form id=\"firstName\"> First Name: <br> <input type=\"text\" name= \"First Name\" class = \"req_fir_name\"><br></form>\n" +
    "</div>");
    var last_name_form = $("<div>   \n" +
    "<form id=\"lastName\"> First Name: <br> <input type=\"text\" name= \"First Name\" class = \"req_las_name\"><br></form>\n" +
    "</div>");
    var password_form = $("<div>   \n"  +
    "<form id=\"password\"> Password: <br> <input type=\"text\" name= \"Password\" class = \"req_password\"><br></form> \n" +
    "</div>");
